...
[![Go Reference](https://pkg.go.dev/badge/github.com/Humphryyy/rod.svg)](https://pkg.go.dev/github.com/Humphryyy/rod)
[![Discord Chat](https://img.shields.io/discord/719933559456006165.svg)][discord room]

## [Documentation](https://go-rod.github.io/) | [API reference](https://pkg.go.dev/github.com/Humphryyy/rod?tab=doc) | [Management](https://github.com/orgs/go-rod/projects/1) | [FAQ](https://go-rod.github.io/#/faq/README)
...
- [CI](https://github.com/Humphryyy/rod/actions) enforced 100% test coverage
...
for example, use Github online [search in repository](https://github.com/Humphryyy/rod/search?q=HandleAuth&unscoped_q=HandleAuth).
You can also search the GitHub [issues](https://github.com/Humphryyy/rod/issues) or [discussions](https://github.com/Humphryyy/rod/discussions),
...
If you have questions, please raise an [issues](https://github.com/Humphryyy/rod/issues)/[discussions](https://github.com/Humphryyy/rod/discussions) or join the [chat room][discord room].
